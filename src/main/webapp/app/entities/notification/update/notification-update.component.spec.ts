...
describe('Notification Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const targetUser: IUser = { id: 26571 };
      notification.targetUser = targetUser;

      const userCollection: IUser[] = [{ id: 1024 }];
      jest.spyOn(userService, 'query').mockReturnValue(of(new HttpResponse({ body: userCollection })));
      const additionalUsers = [targetUser];
    ...
    it('Should update editForm', () => {
      const notification: INotification = { id: 456 };
      const targetUser: IUser = { id: 22511 };
      notification.targetUser = targetUser;

      activatedRoute.data = of({ notification });
      comp.ngOnInit();

      expect(comp.usersSharedCollection).toContain(targetUser);
