...
import { ConsultationService, EntityArrayResponseType } from '../service/consultation.service';
...
export class ConsultationComponent implements OnInit {
  ...
  trackId = (item: IConsultation): number => this.consultationService.getConsultationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.consultations = dataFromBody;
  }
