...
class NotificationResourceIT {
    ...
    private static final NotificationType DEFAULT_NOTIFICATION_TYPE = NotificationType.APPOINTMENT_CONFIRMED;
    private static final NotificationType UPDATED_NOTIFICATION_TYPE = NotificationType.NEW_DOCUMENT;
    ...
    public static Notification createUpdatedEntity(EntityManager em) {
        ...
        em.persist(user);
        em.flush();
        updatedNotification.setTargetUser(user);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.notificationType(UPDATED_NOTIFICATION_TYPE).creationDate(UPDATED_CREATION_DATE);
